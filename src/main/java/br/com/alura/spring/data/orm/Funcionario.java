...
public class Funcionario {
	...
	public String toString() {
		return "Funcionario [id=" + id + ", nome=" + nome + ", cpf=" + cpf + ", cargo=" + cargo.getDescricao() + ", salario=" + salario
				+ ", dataContratacao=" + dataContratacao + ", Unidade=" + unidadeTrabalhos.get(0).getDescricao() + "]";
	}
